...
export default function HeroA({ data = EMPTY_PORTFOLIO, ...personalData }) {
	...
	return (
		<section className="py-6 sm:py-10 md:py-16 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white">
			<div className="max-w-full px-2 sm:px-4 mx-auto">
				...
				{subtitle && <h2 className="text-base sm:text-xl text-blue-100 mb-2 sm:mb-6">{subtitle}</h2>}
				{tagline && (
					<p className="text-sm sm:text-lg text-blue-50 max-w-full sm:max-w-2xl mx-auto">{tagline}</p>
				)}
			</div>
		</section>
	);
