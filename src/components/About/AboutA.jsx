...
export default function AboutA({ summary = "Professional summary not available.", data = EMPTY_PORTFOLIO }) {
	// Use new schema data if available, fallback to legacy prop
	const aboutData = data.about || {};
	const displaySummary = aboutData.summary || summary || "Professional summary not available.";
	...
	return (
		<section className="py-12 px-6">
			...
			<div className="max-w-4xl space-y-6">
				...
				{(interests.length > 0 || personalValues.length > 0 || funFacts.length > 0) && (
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
						...
						{personalValues.length > 0 && (
							<div>
								<h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Values</h3>
								<ul className="space-y-2">
						...
						{funFacts.length > 0 && (
							<div>
								<h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Fun Facts</h3>
								<ul className="space-y-2">
